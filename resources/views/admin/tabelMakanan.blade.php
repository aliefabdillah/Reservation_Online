...
@section('content')
    ...
    <div class="modal fade" id="formInsertMenu" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            ...
            <div class="modal-body">
                <form class="form" action="{{ route('addMenu', ['kategori' => 'makanan']) }}" method="post">
                    @csrf
                    <div class="container-md p-4 my-3 border">
                        <div class="row mb-3">
                            <label>Nama Makanan</label>  
                            <input class="form-control" type="text" name="namaMenu" placeholder="sate" required>
                        </div>
                        <div class="row mb-3">
                            <label>Harga</label>  
                            <input class="form-control" type="text" name="harga" placeholder="12XXX">
                        </div>
                        <div class="row mb-3">
                            <label>Stok</label>  
                            <input class="form-control" type="text" name="stok" placeholder="100">
                        </div>
                    </div>
    ...
    <div class="modal fade" id="formEditMenu" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            ...
            <div class="modal-body">
                <form class="form" action="{{ route('editMenu', ['kategori' => 'makanan']) }}" method="post">
                    @csrf
                    @method('PUT')
                    <div class="container-md p-4 my-3 border">
                        ...
                        <div class="row mb-3">
                            <label>Harga</label>  
                            <input class="form-control" type="text" name="harga" id="fharga">
                        </div>
                        <div class="row mb-3">
                            <label>Stok</label>  
                            <input class="form-control" type="text" name="stok" id="fstok">
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
